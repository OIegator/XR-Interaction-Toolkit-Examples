...
public class LegStepper : MonoBehaviour
{
    ...
    [SerializeField] private float wantStepAtDistance = 1f;
    ...
    [SerializeField, Range(0, 1)] private float stepOvershootFraction;
    ...
    [SerializeField] private float wantStepAtAngle = 135f;
    ...
    IEnumerator MoveToPointCoroutine(Vector3 endPoint, Quaternion endRot, float moveTime)
    {
        ...
        centerPoint += homeTransform.up * Vector3.Distance(startPoint, endPoint) / 1f;
